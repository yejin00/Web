...
class PopupForm(forms.Form):
    ...
    총지수전년동월비= forms.DecimalField(label='총지수전년동월비', initial=1.18)
    신선식품지수전년동월비= forms.DecimalField(label='신선식품지수전년동월비', initial=5)
    ...
    평균풍속 = forms.DecimalField(label='평균풍속', initial=2.21)
    월합강수량= forms.DecimalField(label='월합강수량', initial=239.229)
    총지수전년누계비 =forms.DecimalField(label='총지수전년누계비', initial=10)
    신선식품지수전년누계비 =forms.DecimalField(label='신선식품지수전년누계비', initial=10)