...
def busan(request):
    ...
    if request.method == 'POST':
       ...
       월합강수량, 총지수전년누계비, 신선식품지수전년누계비, 배추상중]]
        ...
        data_high = {'년': 2022, '월': 1, '배추상품' : 1, '배추중품': 0, '서울' : 0, '부산' : 1, '대구':1, '광주':0, '대전':0, 
        ...
        data_middle = {'년': 2022, '월': 1, '배추상품' : 0, '배추중품': 1, '서울' : 0, '부산' : 1, '대구':1, '광주':0, '대전':0, 
                '면적': 6, '생산량': 771, '물가지수': 136, '총지수전년동월비':1.18, '신선식품지수전년동월비':5, 
                '평균기온':-1.5, '평균최고기온':2.842857 , '평균최저기온': -5.471429, '평균상대습도': 52.8, '평균풍속': 2.12, '월합강수량': 239.229, 
                '총지수전년누계비': 10, '신선식품지수전년누계비':10, '배추상중': 0,
             }
        data_mean = {'년': 2022, '월': 1, '배추상품' : 0, '배추중품': 0, '서울' : 0, '부산' : 1, '대구':1, '광주':0, '대전':0, 
                '면적': 6, '생산량': 771, '물가지수': 136, '총지수전년동월비':1.18, '신선식품지수전년동월비':5, 
                '평균기온':-1.5, '평균최고기온':2.842857 , '평균최저기온': -5.471429, '평균상대습도': 52.8, '평균풍속': 2.12, '월합강수량': 239.229, 
